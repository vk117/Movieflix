...
class PayedUsers extends React.Component {
      ...
      getUsers = () => {
            ...
            }, "/v1/api/analytics/pay_per_user", "get");
            ...
            return (
                  ...
                  <div className="home-page">
                        ...
                        <div className="page-title">
                              <h2>Users who Paid for View on Demand recently <a href="/dashboard" className="btn btn-secondary">Back</a> </h2>
...
export default rBridge(PayedUsers);
